...
export const translations = {
  en: {
    ...
    sidebar_about: 'About',
    sidebar_copyright: '© 2024 VIBEJAM EDITORIAL',
    // Bottom Tab Bar
    tab_home: 'Home',
    tab_ai_chat: 'AI Chat',
    tab_create: 'Create',
    ...
    auth_register_subtitle: 'Join the VibeJammer community and start creating',
    auth_email: 'Email',
  ...
  'zh-TW': {
    ...
    sidebar_about: '關於',
    sidebar_copyright: '© 2024 VIBEJAM 編輯部',
    // Bottom Tab Bar
    tab_home: '首頁',
    tab_ai_chat: 'AI 聊天',
    tab_create: '創建',
    ...
    auth_register_subtitle: '加入 VibeJammer 社群，開始創作',
    auth_email: '電子郵件',
    auth_password: '密碼',
