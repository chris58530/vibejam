  ...
  return (
    <footer className="flex flex-col sm:flex-row justify-between items-center px-8 py-10 bg-[#131313] border-t border-outline-variant/10 gap-4">
      <div className="flex flex-col gap-1 items-center sm:items-start">
        <span className="text-sm font-bold text-[#E5E2E1] font-sans">BeaverKit</span>
        <p className="font-mono text-[10px] uppercase tracking-widest text-[#E5E2E1]/40">© 2024 BeaverKit Editorial</p>
      </div>
